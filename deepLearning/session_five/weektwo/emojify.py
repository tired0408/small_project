# 参考地址：https://blog.csdn.net/Koala_Tree/article/details/79455764
import numpy as np
from deepLearning.session_five.weektwo.utils.emo_utils import *
import emoji
...
X = np.asarray(["I am going to the bar tonight", "I love you", "miss you my dear",
                ...
                "It is suprising how people can be dumb somtimes",
                "I am very disappointed", "It is the best day in my list",
...
print("weight[0][1][3] = ", embedding_layer.get_weights()[0][1][3])
print("-"*100)
