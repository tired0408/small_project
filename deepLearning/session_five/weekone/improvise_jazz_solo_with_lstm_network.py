# 参考地址：https://blog.csdn.net/qq_25436597/article/details/79818739
# https://blog.csdn.net/JUNJUN_ZHAO/article/details/79420913
...
from deepLearning.session_five.weekone.utils.qa import *
...
from deepLearning.session_five.weekone.utils.data_utils import *
...
# IPython.display.Audio("data/30s_seq.mp3")  # jupyter页面播放
# 共 60 个训练样本，每个训练样本的 序列长度是 30 ，音符和弦相关的汇集表共 78
...
# IPython.display.Audio("./ijswl_data/data/30s_trained_model.mp3")
